...
namespace soil {
    ...
    public:
        ...
        file(std::observer_ptr<FileNode> parent, std::string &&name, std::string &&extension = {}) noexcept {
            FileNode node{};
        ...
        constexpr inline usize last_pushed_index() const noexcept { return this->as_folder().children.size() - 1; }

        constexpr static FileNode folder(std::observer_ptr<FileNode> parent, std::string &&name) noexcept {
            FileNode node{};
        ...
        constexpr inline bool is_file() const noexcept { return std::holds_alternative<File>(this->inner_file); }
        ...
        constexpr inline bool name_changed(usize old_hash) const noexcept { return this->name_hash != old_hash; }
    ...
    public:
        ...
        FilesystemTree(std::filesystem::path &&root_path) noexcept : root_path(root_path) { this->index(); };
